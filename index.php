...
<body style="background-color: #ff0000;color; white">
	<div clawss="container">
		...
		<div id="gridder-content-0" class="gridder-content" >
			<div class="row">
				<div class="col-sm-6">
					<img src="img/manticora.hpg" class="img-responsive" />			
				</div>
				<div clas="col-sm-6">
					<h2>Manticora</h2>
	...
	$(document).ready(function(){
		$(".gridder").gridderExpander({
			...
			scrollOffset: 60,
			        ...
			        closeText: "<i class=\"fa fa-times\"></i>", onStart: function(){
